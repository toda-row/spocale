...
<div class="panel panel-default">
    <div>
        <h4>プライバシーポリシー</h4>
        <p>
            スポカレ（以下，「当社」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）におけるプライバシー情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。  
        </p>
    </div>
    ...
    <div>
        ...
        <p>
            社名：IT情報サービス同号会社 Eメールアドレス：info@itjoho.com
        </p>
    </div>
